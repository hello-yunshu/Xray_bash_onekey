...
* Поддерживает двойной стек IPv4 / IPv6: может автоматически определять возможности экспорта в общедоступную сеть во время установки, записывать независимую проверку на основе доменного имени A/AAAA и генерировать соответствующие ссылки для общего доступа и конфигурации Clash.
...
RillML (сокращенно Rill) обеспечивает локальную адаптивную интеллектуальную эксплуатацию и возможности обслуживания для Xray.
