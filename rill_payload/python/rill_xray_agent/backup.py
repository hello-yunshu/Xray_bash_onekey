...
def create_backup(out,sources,meta=None,now=0):
 ...
 m={'schemaVersion':2,'kind':'state','createdAtEpochSeconds':now,'candidateVersion':'0.9.0-rc.1','platform':platform.system().lower(),'entries':entries,**(meta or {})};epoch=(2026,8,4,0,0,0)
